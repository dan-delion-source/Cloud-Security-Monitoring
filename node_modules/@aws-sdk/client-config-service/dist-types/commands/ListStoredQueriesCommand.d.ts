...
declare const ListStoredQueriesCommand_base: {
    new (input: ListStoredQueriesCommandInput): import("@smithy/core/client").CommandImpl<ListStoredQueriesCommandInput, ListStoredQueriesCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListStoredQueriesCommandInput]): import("@smithy/core/client").CommandImpl<ListStoredQueriesCommandInput, ListStoredQueriesCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
