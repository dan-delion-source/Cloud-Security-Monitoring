...
declare const PutConformancePackCommand_base: {
    new (input: PutConformancePackCommandInput): import("@smithy/core/client").CommandImpl<PutConformancePackCommandInput, PutConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutConformancePackCommandInput): import("@smithy/core/client").CommandImpl<PutConformancePackCommandInput, PutConformancePackCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
