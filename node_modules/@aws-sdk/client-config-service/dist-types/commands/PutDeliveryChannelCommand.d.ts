...
declare const PutDeliveryChannelCommand_base: {
    new (input: PutDeliveryChannelCommandInput): import("@smithy/core/client").CommandImpl<PutDeliveryChannelCommandInput, PutDeliveryChannelCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutDeliveryChannelCommandInput): import("@smithy/core/client").CommandImpl<PutDeliveryChannelCommandInput, PutDeliveryChannelCommandOutput, ConfigServiceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
