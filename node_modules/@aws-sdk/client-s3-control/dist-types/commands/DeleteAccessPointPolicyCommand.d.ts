...
import type { DeleteAccessPointPolicyRequest } from "../models/models_0";
...
declare const DeleteAccessPointPolicyCommand_base: {
    new (input: DeleteAccessPointPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccessPointPolicyCommandInput, DeleteAccessPointPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteAccessPointPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccessPointPolicyCommandInput, DeleteAccessPointPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
