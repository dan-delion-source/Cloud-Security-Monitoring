...
import type { DeleteAccessPointPolicyForObjectLambdaRequest } from "../models/models_0";
...
declare const DeleteAccessPointPolicyForObjectLambdaCommand_base: {
    new (input: DeleteAccessPointPolicyForObjectLambdaCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccessPointPolicyForObjectLambdaCommandInput, DeleteAccessPointPolicyForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteAccessPointPolicyForObjectLambdaCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccessPointPolicyForObjectLambdaCommandInput, DeleteAccessPointPolicyForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
