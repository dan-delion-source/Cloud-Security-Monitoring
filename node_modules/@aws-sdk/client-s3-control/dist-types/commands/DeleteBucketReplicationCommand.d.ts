...
declare const DeleteBucketReplicationCommand_base: {
    new (input: DeleteBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<DeleteBucketReplicationCommandInput, DeleteBucketReplicationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<DeleteBucketReplicationCommandInput, DeleteBucketReplicationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
