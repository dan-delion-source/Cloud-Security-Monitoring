...
import type { DeleteStorageLensConfigurationTaggingRequest, DeleteStorageLensConfigurationTaggingResult } from "../models/models_0";
...
declare const DeleteStorageLensConfigurationTaggingCommand_base: {
    new (input: DeleteStorageLensConfigurationTaggingCommandInput): import("@smithy/core/client").CommandImpl<DeleteStorageLensConfigurationTaggingCommandInput, DeleteStorageLensConfigurationTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteStorageLensConfigurationTaggingCommandInput): import("@smithy/core/client").CommandImpl<DeleteStorageLensConfigurationTaggingCommandInput, DeleteStorageLensConfigurationTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
