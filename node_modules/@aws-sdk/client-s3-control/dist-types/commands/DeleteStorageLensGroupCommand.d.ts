...
declare const DeleteStorageLensGroupCommand_base: {
    new (input: DeleteStorageLensGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteStorageLensGroupCommandInput, DeleteStorageLensGroupCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteStorageLensGroupCommandInput): import("@smithy/core/client").CommandImpl<DeleteStorageLensGroupCommandInput, DeleteStorageLensGroupCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
