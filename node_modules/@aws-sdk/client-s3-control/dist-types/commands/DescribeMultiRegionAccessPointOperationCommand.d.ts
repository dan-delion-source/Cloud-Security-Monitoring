...
import type { DescribeMultiRegionAccessPointOperationRequest, DescribeMultiRegionAccessPointOperationResult } from "../models/models_0";
...
declare const DescribeMultiRegionAccessPointOperationCommand_base: {
    new (input: DescribeMultiRegionAccessPointOperationCommandInput): import("@smithy/core/client").CommandImpl<DescribeMultiRegionAccessPointOperationCommandInput, DescribeMultiRegionAccessPointOperationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeMultiRegionAccessPointOperationCommandInput): import("@smithy/core/client").CommandImpl<DescribeMultiRegionAccessPointOperationCommandInput, DescribeMultiRegionAccessPointOperationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
