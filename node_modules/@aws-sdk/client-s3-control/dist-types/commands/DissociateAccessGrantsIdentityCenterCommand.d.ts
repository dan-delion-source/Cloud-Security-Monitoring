...
declare const DissociateAccessGrantsIdentityCenterCommand_base: {
    new (input: DissociateAccessGrantsIdentityCenterCommandInput): import("@smithy/core/client").CommandImpl<DissociateAccessGrantsIdentityCenterCommandInput, DissociateAccessGrantsIdentityCenterCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DissociateAccessGrantsIdentityCenterCommandInput]): import("@smithy/core/client").CommandImpl<DissociateAccessGrantsIdentityCenterCommandInput, DissociateAccessGrantsIdentityCenterCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
