...
declare const GetAccessGrantsInstanceCommand_base: {
    new (input: GetAccessGrantsInstanceCommandInput): import("@smithy/core/client").CommandImpl<GetAccessGrantsInstanceCommandInput, GetAccessGrantsInstanceCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetAccessGrantsInstanceCommandInput]): import("@smithy/core/client").CommandImpl<GetAccessGrantsInstanceCommandInput, GetAccessGrantsInstanceCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
