...
import type { GetAccessGrantsInstanceForPrefixRequest, GetAccessGrantsInstanceForPrefixResult } from "../models/models_0";
...
declare const GetAccessGrantsInstanceForPrefixCommand_base: {
    new (input: GetAccessGrantsInstanceForPrefixCommandInput): import("@smithy/core/client").CommandImpl<GetAccessGrantsInstanceForPrefixCommandInput, GetAccessGrantsInstanceForPrefixCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAccessGrantsInstanceForPrefixCommandInput): import("@smithy/core/client").CommandImpl<GetAccessGrantsInstanceForPrefixCommandInput, GetAccessGrantsInstanceForPrefixCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
