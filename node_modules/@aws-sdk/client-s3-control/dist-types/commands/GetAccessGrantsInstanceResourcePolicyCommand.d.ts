...
import type { GetAccessGrantsInstanceResourcePolicyRequest, GetAccessGrantsInstanceResourcePolicyResult } from "../models/models_0";
...
declare const GetAccessGrantsInstanceResourcePolicyCommand_base: {
    new (input: GetAccessGrantsInstanceResourcePolicyCommandInput): import("@smithy/core/client").CommandImpl<GetAccessGrantsInstanceResourcePolicyCommandInput, GetAccessGrantsInstanceResourcePolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetAccessGrantsInstanceResourcePolicyCommandInput]): import("@smithy/core/client").CommandImpl<GetAccessGrantsInstanceResourcePolicyCommandInput, GetAccessGrantsInstanceResourcePolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
