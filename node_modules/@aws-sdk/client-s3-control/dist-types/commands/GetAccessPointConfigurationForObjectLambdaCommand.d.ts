...
import type { GetAccessPointConfigurationForObjectLambdaRequest, GetAccessPointConfigurationForObjectLambdaResult } from "../models/models_0";
...
declare const GetAccessPointConfigurationForObjectLambdaCommand_base: {
    new (input: GetAccessPointConfigurationForObjectLambdaCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointConfigurationForObjectLambdaCommandInput, GetAccessPointConfigurationForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAccessPointConfigurationForObjectLambdaCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointConfigurationForObjectLambdaCommandInput, GetAccessPointConfigurationForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
