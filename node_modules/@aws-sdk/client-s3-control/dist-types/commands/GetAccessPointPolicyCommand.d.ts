...
import type { GetAccessPointPolicyRequest, GetAccessPointPolicyResult } from "../models/models_0";
...
declare const GetAccessPointPolicyCommand_base: {
    new (input: GetAccessPointPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointPolicyCommandInput, GetAccessPointPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAccessPointPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointPolicyCommandInput, GetAccessPointPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
