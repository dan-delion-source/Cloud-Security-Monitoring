...
import type { GetAccessPointPolicyForObjectLambdaRequest, GetAccessPointPolicyForObjectLambdaResult } from "../models/models_0";
...
declare const GetAccessPointPolicyForObjectLambdaCommand_base: {
    new (input: GetAccessPointPolicyForObjectLambdaCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointPolicyForObjectLambdaCommandInput, GetAccessPointPolicyForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAccessPointPolicyForObjectLambdaCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointPolicyForObjectLambdaCommandInput, GetAccessPointPolicyForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
