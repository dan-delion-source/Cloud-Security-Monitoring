...
import type { GetAccessPointPolicyStatusForObjectLambdaRequest, GetAccessPointPolicyStatusForObjectLambdaResult } from "../models/models_0";
...
declare const GetAccessPointPolicyStatusForObjectLambdaCommand_base: {
    new (input: GetAccessPointPolicyStatusForObjectLambdaCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointPolicyStatusForObjectLambdaCommandInput, GetAccessPointPolicyStatusForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAccessPointPolicyStatusForObjectLambdaCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointPolicyStatusForObjectLambdaCommandInput, GetAccessPointPolicyStatusForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
