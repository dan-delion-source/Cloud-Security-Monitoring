...
declare const GetAccessPointScopeCommand_base: {
    new (input: GetAccessPointScopeCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointScopeCommandInput, GetAccessPointScopeCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAccessPointScopeCommandInput): import("@smithy/core/client").CommandImpl<GetAccessPointScopeCommandInput, GetAccessPointScopeCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
