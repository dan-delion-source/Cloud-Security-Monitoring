...
import type { GetBucketRequest, GetBucketResult } from "../models/models_0";
...
declare const GetBucketCommand_base: {
    new (input: GetBucketCommandInput): import("@smithy/core/client").CommandImpl<GetBucketCommandInput, GetBucketCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetBucketCommandInput): import("@smithy/core/client").CommandImpl<GetBucketCommandInput, GetBucketCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
