...
declare const GetBucketPolicyCommand_base: {
    new (input: GetBucketPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetBucketPolicyCommandInput, GetBucketPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetBucketPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetBucketPolicyCommandInput, GetBucketPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
