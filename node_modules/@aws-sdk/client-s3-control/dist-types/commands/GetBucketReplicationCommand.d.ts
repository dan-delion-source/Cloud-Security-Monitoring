...
declare const GetBucketReplicationCommand_base: {
    new (input: GetBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketReplicationCommandInput, GetBucketReplicationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketReplicationCommandInput, GetBucketReplicationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
