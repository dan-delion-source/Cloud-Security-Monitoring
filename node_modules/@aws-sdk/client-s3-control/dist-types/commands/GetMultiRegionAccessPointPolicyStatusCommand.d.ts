...
import type { GetMultiRegionAccessPointPolicyStatusRequest, GetMultiRegionAccessPointPolicyStatusResult } from "../models/models_0";
...
declare const GetMultiRegionAccessPointPolicyStatusCommand_base: {
    new (input: GetMultiRegionAccessPointPolicyStatusCommandInput): import("@smithy/core/client").CommandImpl<GetMultiRegionAccessPointPolicyStatusCommandInput, GetMultiRegionAccessPointPolicyStatusCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetMultiRegionAccessPointPolicyStatusCommandInput): import("@smithy/core/client").CommandImpl<GetMultiRegionAccessPointPolicyStatusCommandInput, GetMultiRegionAccessPointPolicyStatusCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
