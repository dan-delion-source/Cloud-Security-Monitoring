...
declare const GetStorageLensConfigurationCommand_base: {
    new (input: GetStorageLensConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetStorageLensConfigurationCommandInput, GetStorageLensConfigurationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetStorageLensConfigurationCommandInput): import("@smithy/core/client").CommandImpl<GetStorageLensConfigurationCommandInput, GetStorageLensConfigurationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
