...
import type { GetStorageLensConfigurationTaggingRequest, GetStorageLensConfigurationTaggingResult } from "../models/models_0";
...
declare const GetStorageLensConfigurationTaggingCommand_base: {
    new (input: GetStorageLensConfigurationTaggingCommandInput): import("@smithy/core/client").CommandImpl<GetStorageLensConfigurationTaggingCommandInput, GetStorageLensConfigurationTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetStorageLensConfigurationTaggingCommandInput): import("@smithy/core/client").CommandImpl<GetStorageLensConfigurationTaggingCommandInput, GetStorageLensConfigurationTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
