...
declare const ListAccessGrantsInstancesCommand_base: {
    new (input: ListAccessGrantsInstancesCommandInput): import("@smithy/core/client").CommandImpl<ListAccessGrantsInstancesCommandInput, ListAccessGrantsInstancesCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListAccessGrantsInstancesCommandInput]): import("@smithy/core/client").CommandImpl<ListAccessGrantsInstancesCommandInput, ListAccessGrantsInstancesCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
