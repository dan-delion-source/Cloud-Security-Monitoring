...
import type { ListAccessPointsForDirectoryBucketsRequest, ListAccessPointsForDirectoryBucketsResult } from "../models/models_0";
...
declare const ListAccessPointsForDirectoryBucketsCommand_base: {
    new (input: ListAccessPointsForDirectoryBucketsCommandInput): import("@smithy/core/client").CommandImpl<ListAccessPointsForDirectoryBucketsCommandInput, ListAccessPointsForDirectoryBucketsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListAccessPointsForDirectoryBucketsCommandInput]): import("@smithy/core/client").CommandImpl<ListAccessPointsForDirectoryBucketsCommandInput, ListAccessPointsForDirectoryBucketsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
