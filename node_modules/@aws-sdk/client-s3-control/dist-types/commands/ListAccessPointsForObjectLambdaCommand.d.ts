...
declare const ListAccessPointsForObjectLambdaCommand_base: {
    new (input: ListAccessPointsForObjectLambdaCommandInput): import("@smithy/core/client").CommandImpl<ListAccessPointsForObjectLambdaCommandInput, ListAccessPointsForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListAccessPointsForObjectLambdaCommandInput]): import("@smithy/core/client").CommandImpl<ListAccessPointsForObjectLambdaCommandInput, ListAccessPointsForObjectLambdaCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
