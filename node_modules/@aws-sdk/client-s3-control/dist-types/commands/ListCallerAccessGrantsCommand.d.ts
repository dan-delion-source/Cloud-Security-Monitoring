...
declare const ListCallerAccessGrantsCommand_base: {
    new (input: ListCallerAccessGrantsCommandInput): import("@smithy/core/client").CommandImpl<ListCallerAccessGrantsCommandInput, ListCallerAccessGrantsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListCallerAccessGrantsCommandInput]): import("@smithy/core/client").CommandImpl<ListCallerAccessGrantsCommandInput, ListCallerAccessGrantsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
