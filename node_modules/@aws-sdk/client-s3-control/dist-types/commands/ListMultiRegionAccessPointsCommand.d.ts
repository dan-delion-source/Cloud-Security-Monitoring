...
declare const ListMultiRegionAccessPointsCommand_base: {
    new (input: ListMultiRegionAccessPointsCommandInput): import("@smithy/core/client").CommandImpl<ListMultiRegionAccessPointsCommandInput, ListMultiRegionAccessPointsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListMultiRegionAccessPointsCommandInput]): import("@smithy/core/client").CommandImpl<ListMultiRegionAccessPointsCommandInput, ListMultiRegionAccessPointsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
