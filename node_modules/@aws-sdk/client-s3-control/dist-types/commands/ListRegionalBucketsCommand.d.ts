...
declare const ListRegionalBucketsCommand_base: {
    new (input: ListRegionalBucketsCommandInput): import("@smithy/core/client").CommandImpl<ListRegionalBucketsCommandInput, ListRegionalBucketsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListRegionalBucketsCommandInput]): import("@smithy/core/client").CommandImpl<ListRegionalBucketsCommandInput, ListRegionalBucketsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
