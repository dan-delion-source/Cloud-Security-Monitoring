...
declare const ListStorageLensGroupsCommand_base: {
    new (input: ListStorageLensGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListStorageLensGroupsCommandInput, ListStorageLensGroupsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListStorageLensGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListStorageLensGroupsCommandInput, ListStorageLensGroupsCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
