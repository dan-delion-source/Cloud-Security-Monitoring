...
declare const PutAccessPointPolicyCommand_base: {
    new (input: PutAccessPointPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutAccessPointPolicyCommandInput, PutAccessPointPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutAccessPointPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutAccessPointPolicyCommandInput, PutAccessPointPolicyCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
