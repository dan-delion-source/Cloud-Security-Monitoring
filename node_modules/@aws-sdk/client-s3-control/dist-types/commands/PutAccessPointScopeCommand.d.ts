...
declare const PutAccessPointScopeCommand_base: {
    new (input: PutAccessPointScopeCommandInput): import("@smithy/core/client").CommandImpl<PutAccessPointScopeCommandInput, PutAccessPointScopeCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutAccessPointScopeCommandInput): import("@smithy/core/client").CommandImpl<PutAccessPointScopeCommandInput, PutAccessPointScopeCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
