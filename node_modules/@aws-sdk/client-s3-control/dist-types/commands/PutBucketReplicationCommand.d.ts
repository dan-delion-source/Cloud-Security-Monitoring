...
declare const PutBucketReplicationCommand_base: {
    new (input: PutBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<PutBucketReplicationCommandInput, PutBucketReplicationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<PutBucketReplicationCommandInput, PutBucketReplicationCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
