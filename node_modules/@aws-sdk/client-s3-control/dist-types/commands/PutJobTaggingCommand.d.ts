...
import type { PutJobTaggingRequest, PutJobTaggingResult } from "../models/models_0";
...
declare const PutJobTaggingCommand_base: {
    new (input: PutJobTaggingCommandInput): import("@smithy/core/client").CommandImpl<PutJobTaggingCommandInput, PutJobTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutJobTaggingCommandInput): import("@smithy/core/client").CommandImpl<PutJobTaggingCommandInput, PutJobTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
