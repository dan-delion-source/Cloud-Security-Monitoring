...
import type { PutStorageLensConfigurationTaggingRequest, PutStorageLensConfigurationTaggingResult } from "../models/models_0";
...
declare const PutStorageLensConfigurationTaggingCommand_base: {
    new (input: PutStorageLensConfigurationTaggingCommandInput): import("@smithy/core/client").CommandImpl<PutStorageLensConfigurationTaggingCommandInput, PutStorageLensConfigurationTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutStorageLensConfigurationTaggingCommandInput): import("@smithy/core/client").CommandImpl<PutStorageLensConfigurationTaggingCommandInput, PutStorageLensConfigurationTaggingCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
