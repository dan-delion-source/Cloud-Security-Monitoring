...
import type { SubmitMultiRegionAccessPointRoutesRequest, SubmitMultiRegionAccessPointRoutesResult } from "../models/models_0";
...
declare const SubmitMultiRegionAccessPointRoutesCommand_base: {
    new (input: SubmitMultiRegionAccessPointRoutesCommandInput): import("@smithy/core/client").CommandImpl<SubmitMultiRegionAccessPointRoutesCommandInput, SubmitMultiRegionAccessPointRoutesCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SubmitMultiRegionAccessPointRoutesCommandInput): import("@smithy/core/client").CommandImpl<SubmitMultiRegionAccessPointRoutesCommandInput, SubmitMultiRegionAccessPointRoutesCommandOutput, S3ControlClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
